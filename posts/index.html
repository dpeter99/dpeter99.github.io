...
<head>
    ...
    <title>Posts</title>
    <meta content="dpeter99 - Posts" property="og:title" />
    <meta content="" property="og:description" />
    <meta content=" https://dpeter99.github.io/posts " property="og:url" />
  ...
  <image
    ...
    <div class="card">
        <ul class="article-list">
            ...
            <li >
                <a href="https://dpeter99.github.io/posts/2022-03-04-game-io-logic">
            ...
            <li >
                <a href="https://dpeter99.github.io/posts/forge_118">
                <div class="card card--outline">
                    <h3>
                        Forge 1.18 update
                    </h3>
            ...
            <li >
                <a href="https://dpeter99.github.io/posts/forge_117">
                <div class="card card--outline">
                    <h3>
                        Forge 1.17 update
                    </h3>
            ...
            <li >
                <a href="https://dpeter99.github.io/posts/broken_ssd">
                <div class="card card--outline">
                    <h3>
                        Broken SSD
                    </h3>
