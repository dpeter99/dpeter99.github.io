...
<head>
    ...
    <title>ACFT</title>
    <meta content="dpeter99 - ACFT" property="og:title" />
    <meta content="Almost Comprehensive Forge Tutorial. was abandoned in favor of the Community Wiki" property="og:description" />
    <meta content=" https://dpeter99.github.io/projects/ACTF " property="og:url" />
...
<main class="article">
    <article class="card">
        <div>
            <project-title title="ACFT" status="[&#34;abandoned&#34;]" repo=""></project-title>
        </div>
        <div>
            <p><strong>This project is discontinued</strong></p>
<p>Currently, I only use this site for a short text that describes the status of forge update to the newer version.</p>
<h3 class="heading" id="the-origin" tabindex="-1"><a href="#the-origin"></a>The origin</h3>
<p>This was a plan for a community-made Forge modding tutorial. While it was a good idea many of the write-ups for it ended up in <a href="https://forge.gemwire.uk/wiki/Main_Page">Forge Community Wiki</a>
